...
서비스의 빈틈을 찾아내고 반복되는 불편함을 기술로 해결하는 개발자입니다.
- **불필요한 커뮤니케이션 최소화:** 디자인/기획 팀과의 협업 구조를 개선하여 개발 지원 리소스를 **60% 절감**했습니다.
- **철저한 안정성 지향:** 결제 및 캐시 로직 수정 시 **1만 건 이상의 TDD 케이스**를 수행하여 무결성을 보장합니다.
- **자동화에 진심인 편:** 50여 대 서버의 로그 압축 및 용량 관리를 자동화하여 **수작업 시간을 10분의 1**로 줄였습니다.

현재는 레거시 환경을 존중하면서도 현대적인 자동화 툴을 도입하여 시스템의 체력을 키우는 데 집중하고 있습니다.
